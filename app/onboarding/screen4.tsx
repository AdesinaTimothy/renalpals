        ...
        <SafeAreaView className="flex-1 px-8 pt-16">
          ...
          <View className="flex-1 justify-center items-center pb-10">
            ...
            <Text className="text-[16px] text-white/85 text-center leading-6 px-3 font-medium">
              Access educational resources to understand your treatment and make
              informed decisions.
            </Text>
          </View>
        </SafeAreaView>
      ...
      >
        <SafeAreaView edges={["bottom"]}>
          ...
          <View className="flex-row justify-center items-center gap-2 mb-7">
            ...
            <View className="h-2 w-2 rounded-full bg-slate-300" />
            <View className="h-2 w-2 rounded-full bg-slate-300" />
            <View className="h-2 w-6 rounded-full bg-emerald-500" />
            <View className="h-2 w-2 rounded-full bg-slate-300" />
          </View>
          ...
          <View className="flex-row justify-between items-center mb-3">
            ...
            <TouchableOpacity
              onPress={handleNext}
              className="flex-row items-center gap-2 bg-emerald-500 py-4 px-8 rounded-2xl"
              activeOpacity={0.8}
              style={{
                shadowColor: "#000",
                shadowOffset: { width: 0, height: 4 },
